...
const en = {
  ...
  'guide.sweep': 'Sweep the sky. Tap anything you want to look at.',
  ...
  'guide.eyepiece': 'It is in the Telrad. Look through the eyepiece.',
  'guide.away': (n: number) => `${n < 10 ? n.toFixed(1) : Math.round(n)}\u00b0 across the sky`,
  'guide.calibrate': 'Compass not calibrated — wave the phone in a figure of eight.',
  'guide.coarse': 'Compass is rough. Treat the direction as approximate.',
...
const me: Record<StringKey, unknown> = {
  ...
  'guide.sweep': 'Prelazi po nebu. Dodirni ono što hoćeš da gledaš.',
  ...
  'guide.eyepiece': 'U Telradu je. Pogledaj kroz sočivo.',
  'guide.away': (n: number) => `${n < 10 ? n.toFixed(1) : Math.round(n)}\u00b0 preko neba`,
  'guide.calibrate': 'Kompas nije baždaren — provrti telefon u obliku osmice.',
  'guide.coarse': 'Kompas je grub. Uzmi smjer kao približan.',
