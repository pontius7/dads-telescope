...
const en = {
  ...
  'search.open': 'Search',
  'search.placeholder': 'Search objects, constellations, screens',
  'search.clear': 'Clear',
  'search.constellation': 'Constellation',
  'search.none': 'Nothing matches that.',
  'log.title': 'Logbook',
  'log.empty': 'Nothing logged yet. Open anything in the sky and mark whether you saw it.',
  'log.sawIt': 'I saw this',
  'log.missedIt': 'Could not see it',
  'log.saved': 'Logged',
  'log.note': 'Add a note',
  'log.notePlaceholder': 'What did it look like?',
  'log.remove': 'Remove',
  'log.nights': (n: number) => (n === 1 ? '1 night out' : `${n} nights out`),
  'log.entries': (n: number) => (n === 1 ? '1 observation' : `${n} observations`),
  'log.noCloud': 'no forecast that night',
  'log.notSeen': 'Not seen',
  'menu.news': 'News',
...
const me: Record<StringKey, unknown> = {
  ...
  'menu.logbook': 'Dnevnik',
  'search.open': 'Pretraga',
  'search.placeholder': 'Tra\u017ei objekte, sazvije\u017e\u0111a, ekrane',
  'search.clear': 'O\u010disti',
  'search.constellation': 'Sazvije\u017e\u0111e',
  'search.none': 'Ni\u0161ta ne odgovara tome.',
  'log.title': 'Dnevnik',
  'log.empty': 'Jo\u0161 ni\u0161ta nije zabilje\u017eeno. Otvori bilo \u0161ta na nebu i ozna\u010di da li si vidio.',
  'log.sawIt': 'Vidio sam ovo',
  'log.missedIt': 'Nisam mogao vidjeti',
  'log.saved': 'Zabilje\u017eeno',
  'log.note': 'Dodaj bilje\u0161ku',
  'log.notePlaceholder': 'Kako je izgledalo?',
  'log.remove': 'Ukloni',
  'log.nights': (n: number) => (n === 1 ? '1 no\u0107 napolju' : `${n} no\u0107i napolju`),
  'log.entries': (n: number) => (n === 1 ? '1 osmatranje' : `${n} osmatranja`),
  'log.noCloud': 'te no\u0107i nije bilo prognoze',
  'log.notSeen': 'Nije vi\u0111eno',
  'menu.news': 'Vijesti',
